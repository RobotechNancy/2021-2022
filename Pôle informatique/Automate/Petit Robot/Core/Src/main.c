...
#include "stm32f3xx_it.h" /*!< Fonctions d'interruptions */
#include "defineActionneur.h"
#include <variableActionneur.h> /* Initialisation des variables */
#include <deplacementActionneur.h> /* Fonction deplacement */
#include <motorActionneur.h> /*!< Fonctions des moteurs */
...
Motor_t motor = {
	...
	.PIN_DIR = DIR_Pin,
	.PIN_EN = EN_Pin,
	.PIN_STEP_TYPE = STEP_GPIO_Port,
	.PIN_DIR_TYPE = DIR_GPIO_Port,
	.PIN_EN_TYPE = EN_GPIO_Port,
	.pinStepState = 0,
	.pinDirState = 0,
	.pinEnState = 1
};
