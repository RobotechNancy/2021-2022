...
|:---:|:---:|:---:|:---:|:---:|:---:|
|Module XBee type S2C|RF : 250Kbps - série: < 1Mbps|60 mètres (intérieur)|Sans fil - Haute Fréquence|9600 bauds - Sans bit de parité - 1 bits de stop - 8 bits de dataa|2,4 GHz avec étalement de spectre|
