...
#define CAN_FILTER_ADDR_EMETTEUR    0b011110000000000000000000000000
#define CAN_FILTER_ADDR_RECEPTEUR   0b000001111000000000000000000000
...
#define CAN_DECALAGE_ADDR_EMETTEUR    25
#define CAN_DECALAGE_ADDR_RECEPTEUR  21
