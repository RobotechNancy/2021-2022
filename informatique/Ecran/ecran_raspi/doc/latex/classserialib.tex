...
\DoxyCodeLine{00138             \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_aa1dfe049c80f3b7d1c52db5b0e00371f}{EC\_SER\_E\_NOT\_FOUND}}; \textcolor{comment}{// Device not found}}
\DoxyCodeLine{00139 }
\DoxyCodeLine{00140         \textcolor{comment}{// Error while opening the device}}
\DoxyCodeLine{00141         \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_ab972a3420c5f8feb55bd46670b9469c5}{EC\_SER\_E\_OPEN}};}
\DoxyCodeLine{00142     \}}
\DoxyCodeLine{00143 }
...
\DoxyCodeLine{00151     \textcolor{keywordflow}{if} (!GetCommState(hSerial, \&dcbSerialParams)) \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_ad840440d09224af079e399ac3ed2d902}{EC\_SER\_E\_PARAM}};}
\DoxyCodeLine{00152 }
...
\DoxyCodeLine{00171     default : \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a985a02376c46ce6c672f2edfd87ea739}{EC\_SER\_E\_UKN\_BAUDRATE}};}
\DoxyCodeLine{00172     \}}
...
\DoxyCodeLine{00181         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a749133de2abca2a050d1a70c44371027}{EC\_SER\_E\_UKN\_DATABITS}};}
\DoxyCodeLine{00182     \}}
...
\DoxyCodeLine{00188         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a8ab9647486dfb3099903912a90078596}{EC\_SER\_E\_UKN\_STOPBITS}};}
\DoxyCodeLine{00189     \}}
...
\DoxyCodeLine{00197         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_af82fc734fb622cc5ac35d571eab1a7d2}{EC\_SER\_E\_UKN\_PARITY}};}
\DoxyCodeLine{00198     \}}
...
\DoxyCodeLine{00207     \textcolor{keywordflow}{if}(!SetCommState(hSerial, \&dcbSerialParams)) \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a3971c58874e59a8a394a6a592440c330}{EC\_SER\_E\_CONFIG}};}
\DoxyCodeLine{00208 }
...
\DoxyCodeLine{00220     \textcolor{keywordflow}{if}(!SetCommTimeouts(hSerial, \&timeouts)) \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a25676a14dea7c6c945af61b89eca96ed}{EC\_SER\_E\_TIMOUT}};}
\DoxyCodeLine{00221 }
...
\DoxyCodeLine{00233     \textcolor{keywordflow}{if} (fd == -\/1) \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_ab972a3420c5f8feb55bd46670b9469c5}{EC\_SER\_E\_OPEN}};}
...
\DoxyCodeLine{00258     default : \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a985a02376c46ce6c672f2edfd87ea739}{EC\_SER\_E\_UKN\_BAUDRATE}};}
\DoxyCodeLine{00259     \}}
...
\DoxyCodeLine{00267         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a749133de2abca2a050d1a70c44371027}{EC\_SER\_E\_UKN\_DATABITS}};}
\DoxyCodeLine{00268     \}}
...
\DoxyCodeLine{00274         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_a8ab9647486dfb3099903912a90078596}{EC\_SER\_E\_UKN\_STOPBITS}};}
\DoxyCodeLine{00275     \}}
...
\DoxyCodeLine{00282         \textcolor{keywordflow}{default}: \textcolor{keywordflow}{return} \mbox{\hyperlink{ecran__define_8h_af82fc734fb622cc5ac35d571eab1a7d2}{EC\_SER\_E\_UKN\_PARITY}};}
\DoxyCodeLine{00283     \}}
\DoxyCodeLine{00284 }
...
\DoxyCodeLine{00299     \textcolor{keywordflow}{return} (\mbox{\hyperlink{ecran__define_8h_a14e080035b40cd7eebb19b61e91047a5}{EC\_SER\_E\_SUCCESS}});}
