...
public:
     ...
     */
    typedef touchgfx::meta::TypeList< AccueilView,
            touchgfx::meta::TypeList< CompetitionView,
            touchgfx::meta::TypeList< MaintenanceView,
            touchgfx::meta::TypeList< MaintenanceTofView,
            touchgfx::meta::TypeList< InformationsTofView,
            touchgfx::meta::TypeList< MaintenanceXbeeView,
            touchgfx::meta::TypeList< MaintenanceCanView,
            touchgfx::meta::TypeList< MaintenanceGyroOptView,
            touchgfx::meta::TypeList< MaintenancePompeAVideView,
            touchgfx::meta::TypeList< MaintenanceServoView,
            touchgfx::meta::TypeList< CompetitionInitialilsationView,
            touchgfx::meta::TypeList< AffichageScoreView,
     ...
     */
    typedef touchgfx::meta::TypeList< AccueilPresenter,
            touchgfx::meta::TypeList< CompetitionPresenter,
            touchgfx::meta::TypeList< MaintenancePresenter,
            touchgfx::meta::TypeList< MaintenanceTofPresenter,
            touchgfx::meta::TypeList< InformationsTofPresenter,
            touchgfx::meta::TypeList< MaintenanceXbeePresenter,
            touchgfx::meta::TypeList< MaintenanceCanPresenter,
            touchgfx::meta::TypeList< MaintenanceGyroOptPresenter,
            touchgfx::meta::TypeList< MaintenancePompeAVidePresenter,
            touchgfx::meta::TypeList< MaintenanceServoPresenter,
            touchgfx::meta::TypeList< CompetitionInitialilsationPresenter,
            touchgfx::meta::TypeList< AffichageScorePresenter,
    ...
    {
        app.gotoAccueilScreenNoTransition();
    }
protected:
